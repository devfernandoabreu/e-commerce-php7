								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p style="float: left; margin-right: 30px" id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input style="float: left; margin: 30px;" type="radio" id="method-pagseguro" name="payment-method" value="1" class="input-text " checked>
												<label style="float: left;" class="" for="method-pagseguro"><img style="height: 64px;" src="/res/site/img/logo-pagseguro.png"></label>
											</p>
											<p style="float: left; margin-right: 30px" id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input style="float: left; margin: 30px;" type="radio" id="method-paypal" name="payment-method" value="2" class="input-text ">
												<label style="float: left;" class="" for="method-paypal"><img style="height: 64px;" src="/res/site/img/logo-paypal.png"></label>
											</p>
											<div style="margin-top: 30px;" class="col-md-12" id="payment">
